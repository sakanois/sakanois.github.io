...
I learned how to apply what we learned in the labs to Assignments 1 and 2. For example, the File I/O lab helped me create the login and registration page for Assignment 1 and have it output the user data information on subsequent pages. I wish we dedicated more class time to completing the labs. We usually spent the first half of the class reviewing what we were already supposed to review before class in the screencast and readings so it felt a little redundant. 
...
Specific challenges I encountered during the course were understanding conditional expressions and operating, and completing Assignment 2, in particular, getting the quantities to decrease when the invoice is generated and making the text fields sticky on the login and registration page. I also had a difficult time with filming the WODs. I felt confident with my ability to go through the whole process without using notes but once I started recording, I would forget certain steps and have to pause or start over. I would also make small mistakes like mistyping a variable or putting an extra semi-colon because I would rush through it so I wouldn't go over the time limit.
...
Application: I felt more confident in my programming abilities and was able to apply what I learned in the course to a real web application. Working on the Assignments was a cumulative exam that tested if I learned anything throughout the semester. I was able to reuse a lot of the code from the WODs like Store1 and Invoice2, as well as the labs, especially Lab 13. 
